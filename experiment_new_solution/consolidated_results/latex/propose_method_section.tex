...
%     \item Distributed clients $\mathcal{C}$: edge devices/silos that keep raw text data local.
%     \item Task set $\mathcal{K}$: heterogeneous NLU tasks (e.g., intent classification, sentiment analysis, sequence labeling).
%     \item Local datasets $\mathcal{D}_c^t$: private, time-indexed data available at client $c$ at round $t$.
% \end{itemize}
