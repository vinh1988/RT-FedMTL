        ...
        try:
            ...
            if "lora_state" in global_state:
                ...
                if lora_params:
                    ...
                    logger.warning("Received empty LoRA parameters in lora_state")
                    params_updated = False
                ...
                logger.warning("No parameters found in global_state (expected 'lora_state', 'model_slice', or 'global_parameters')")
                params_updated = False
