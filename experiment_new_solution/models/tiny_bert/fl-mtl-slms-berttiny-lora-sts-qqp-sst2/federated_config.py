...
class FederatedConfig:
    ...
    use_peft_lora: bool = True  # Enable PEFT LoRA adapters
    ...
    lora_unfreeze_layers: int = 2  # Number of last transformer layers to unfreeze
    lora_bias: str = "none"
    ...
    def _flatten_config_dict(cls, config_dict: Dict) -> Dict:
        ...
        key_mapping = {
            ...
            ('model', 'use_peft_lora'): 'use_peft_lora',
            
            # PEFT LoRA settings
            ('peft_lora', 'rank'): 'lora_rank',
            ('peft_lora', 'alpha'): 'lora_alpha',
            ('peft_lora', 'dropout'): 'lora_dropout',
            ('peft_lora', 'target_modules'): 'lora_target_modules',
            ('peft_lora', 'unfreeze_layers'): 'lora_unfreeze_layers',
            ('peft_lora', 'bias'): 'lora_bias',
            ('peft_lora', 'task_type'): 'lora_task_type',
