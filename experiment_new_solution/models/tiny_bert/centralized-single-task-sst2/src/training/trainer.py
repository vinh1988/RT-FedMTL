...
class CentralizedTrainer:
    ...
    def _save_metrics_to_csv(self, epoch: int, val_results: Dict, training_time: float, train_loss: float):
        ...
        row = [
            ...
            val_results['metrics'].get('accuracy', 0.0),  # sst2_val_accuracy
            val_results['metrics'].get('f1', 0.0),  # sst2_val_f1
            0.0,  # qqp_val_accuracy (empty for SST2-only)
            0.0,  # qqp_val_f1 (empty for SST2-only)
            0.0,  # stsb_val_pearson (empty for SST2-only)
            0.0,  # stsb_val_spearman (empty for SST2-only)
