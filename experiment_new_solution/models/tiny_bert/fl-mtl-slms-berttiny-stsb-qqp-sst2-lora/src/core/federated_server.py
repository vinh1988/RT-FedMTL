...
class FederatedServer:
    ...
    def __init__(self, config: FederatedConfig):
        ...
        # Initialize MTL LoRA Server Model (frozen BERT + shared LoRA + task-specific heads)
        ...
        logger.info("=" * 60)
        logger.info("MTL LoRA Server Model Summary:")
    ...
    def finalize_training(self):
        ...
        try:
            ...
            with open(summary_file, 'w') as f:
                ...
                # Add MTL LoRA model summary
                mtl_summary = self.mtl_model.get_model_summary()
                f.write(f"\nMTL LoRA Model Architecture:\n")
