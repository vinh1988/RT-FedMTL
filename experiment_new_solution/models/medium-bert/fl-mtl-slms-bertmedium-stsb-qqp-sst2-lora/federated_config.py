...
class FederatedConfig:
    ...
    # Partial Unfreezing settings (layers to freeze/unfreeze)
    partial_unfreeze_enabled: bool = True
    layers_to_freeze: int = 4  # Freeze bottom 4 layers for BERT-Medium
    layers_to_unfreeze: int = 4  # Unfreeze top 4 layers (for documentation)
    ...
    def _flatten_config_dict(cls, config_dict: Dict) -> Dict:
        ...
        key_mapping = {
            ...
            # Partial unfreezing settings
            ('partial_unfreeze', 'enabled'): 'partial_unfreeze_enabled',
            ('partial_unfreeze', 'layers_to_freeze'): 'layers_to_freeze',
            ('partial_unfreeze', 'layers_to_unfreeze'): 'layers_to_unfreeze',
