...
class FederatedServer:
    """Federated Learning Server with LoRA and synchronization support"""
    ...
    async def run_federated_training(self):
        ...
        logger.info("Starting federated training with LoRA and synchronization")
        ...
        for round_num in range(1, self.config.num_rounds + 1):
            ...
            try:
                ...
                training_request = MessageProtocol.create_training_request_message(
                    round_num, self.global_lora_params, {}
                )
                await self.websocket_server.broadcast(training_request)

                # Step 3: Wait for client updates
                await self.collect_client_updates(round_num)

                # Step 4: Aggregate LoRA updates from clients
                ...
                # Step 5: Record results for this round
    ...
    def finalize_training(self):
        ...
        try:
            ...
            with open(summary_file, 'w') as f:
                ...
                f.write("=" * 40 + "\n\n")
                f.write(f"Configuration: LoRA + Synchronization\n")
