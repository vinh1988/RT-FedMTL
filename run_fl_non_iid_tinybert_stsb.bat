...
echo Tiny BERT with Standard FL (3 STSB Clients)
...
set WORK_DIR=%PROJECT_ROOT%\experiment_new_solution\models\tiny_bert\fl-slms-mini-lm-non-iid-stsb
...
echo Model: prajjwal1/bert-tiny (Tiny BERT, ~4.4M params)
