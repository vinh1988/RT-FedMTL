...
set WORK_DIR=%PROJECT_ROOT%\experiment_new_solution\models\mini-lm\centralized-single-task-stsb
...
REM ===== Start Centralized Training =====
...
echo Training Type: Centralized Single Task (Regression)
echo.
