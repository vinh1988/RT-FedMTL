...
echo Medium BERT with Standard FL (3 STSB Clients)
...
set WORK_DIR=%PROJECT_ROOT%\experiment_new_solution\models\medium-bert\fl-slms-mini-lm-non-iid-stsb
...
echo Model: prajjwal1/bert-medium (Medium BERT, ~41M params)
