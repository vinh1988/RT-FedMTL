...
echo "Mini BERT with STSB Dataset"
echo "========================================"

# ===== Project paths =====
PROJECT_ROOT="/home/vinh/Documents/code/FedAvgLS_windows/FedAvgLS"
WORK_DIR="$PROJECT_ROOT/experiment_new_solution/models/mini-bert/centralized-single-task-stsb"
...
# ===== Start Centralized STSB Training =====
