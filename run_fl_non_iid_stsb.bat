...
echo MiniLM with Standard FL (3 STSB Clients)
...
set WORK_DIR=%PROJECT_ROOT%\experiment_new_solution\models\mini-lm\fl-slms-mini-lm-non-iid-stsb
...
echo Model: sentence-transformers/all-MiniLM-L6-v2 (MiniLM-L6-H384, ~22M params)
