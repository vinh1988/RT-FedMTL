...
echo Medium BERT with All Tasks (SST2, QQP, STSB)
echo ========================================
...
set WORK_DIR=%PROJECT_ROOT%\experiment_new_solution\models\medium-bert\centralized-mtl-all-tasks
...
echo ========================================
echo.
echo Model: prajjwal1/bert-medium
